...
promptCreator_llm = lyricsCreator_llm()
...
# 做第一次歌詞、曲風生成
try:
    promptCreator_llm.sendMsg(output_dir=OUTPUT_DIR)
...
while evaluation_llm.score < 90:
    try:
        promptCreator_llm.sendMsg(output_dir=OUTPUT_DIR, evaluation=evaluation)
